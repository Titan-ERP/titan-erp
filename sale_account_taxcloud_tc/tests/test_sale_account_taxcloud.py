...
class TestSaleAccountTaxCloud(TestAccountTaxcloudCommon):
    def test_01_taxcloud_full_flow(self):
        ...
        self.assertEqual(
            sale_order.order_line.tax_ids, tax, "Tax should be taken from DB."
        )
        # create downpayment
        payment_ctx = {
        ...
        payment = (
            ...
            .create({
                ...
                'journal_id': self.inbound_payment_method_line.journal_id.id,
        ...
        self.assertNotEqual(
            ...
            msg="Payment amount should match invoice residual amount.",
        )
