...
PLAN = OUT / "odoo_check_rule_reconcile_plan.csv"
...
RULES = [
    {
        ...
        "patterns": [
            r"AgUp",
            r"Ashleigh Auto Parts",
            r"Austin Hose",
            r"B&S Quick Parts",
            r"Blumaq",
            r"CBS Diesel",
            r"Continental Batteries",
            r"Cook Tractor",
            r"Dixie Tractor",
            r"Equipment Inc",
            r"Equipment Rental Services",
            r"Kimball Midwest",
            r"Laurel Rubber",
            r"Lyle Machinery",
            r"M\s*&\s*L Engines",
            r"ML Engines",
            r"Machinery Parts Warehouse",
            r"Mad South Machinery",
            r"Meisel Tractor",
            r"NAPA Laurel",
            r"National Bolt",
            r"Riverside Alternator",
            r"S\s*&\s*S Diesel",
            r"Southern Tractor Service",
            r"Southwest Equipment",
            r"Specialized Parts",
            r"Summit Supply",
            r"Truck Pro",
            r"Universal Auto Parts NAPA",
            r"\bVPI\b",
        ],
    },
    {
        "account": "Facility Expense",
        "patterns": [
            r"Dixie Electric Power Association",
            r"Delta EPA",
            r"Cintas Uniforms",
            r"Ecowaste Solutions",
        ],
    },
    {
    ...
    },
    {
        ...
        "patterns": [
            r"Colonial Life Insurance",
        ],
    },
    {
        "account": "Company Vehicle Expense",
        "patterns": [
            r"Kelley Oil Company",
            r"Gulf South",
            r"\bGulf\b",
        ],
    },
    {
        "account": "Service Cost of Revenue",
        "patterns": [
            r"Hall's Welding",
            r"Hall's Blasting",
            r"Brian Harper",
    ...
    {
        "account": "Other Interest Expense",
        "patterns": [
            r"Citizens Bank Laurel.*Interest",
        ],
    },
    {
        "account": "Rent / Lease Expense",
        "patterns": [
            r"Melvin Family Trust",
            r"Rick Kittrell",
        ],
    },
]
...
def main():
    ...
    for bank in bank_lines:
        ...
        if not payment_ref.lower().startswith("check "):
            continue
        matched = None
        for rule in rules:
    ...
    print(f"Candidate lines: {len(rows)}")
